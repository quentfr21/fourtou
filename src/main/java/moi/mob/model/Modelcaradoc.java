...
public class Modelcaradoc extends ModelBase
{
  //fields
    ModelRenderer head;
    ModelRenderer body;
  ...
  public Modelcaradoc()
  {
    ...
    textureHeight = 64;
      ...
      body1 = new ModelRenderer(this, 12, 35);
      body1.addBox(0F, 0F, 0F, 6, 10, 1);
      body1.setRotationPoint(-3F, 1F, -3F);
      body1.setTextureSize(64, 64);
      body1.mirror = true;
      setRotation(body1, 0F, 0F, 0F);
      body2 = new ModelRenderer(this, 0, 35);
      body2.addBox(0F, 1F, 0F, 4, 5, 1);
      body2.setRotationPoint(-2F, 4F, -4F);
      body2.setTextureSize(64, 64);
      body2.mirror = true;
      setRotation(body2, 0F, 0F, 0F);
      body3 = new ModelRenderer(this, 27, 35);
      body3.addBox(0F, 0F, 0F, 6, 10, 1);
      body3.setRotationPoint(-3F, 1F, 2F);
